# Picovoice SDK for Arduino boards - Hindi language
...
1. Compile and upload the `Picovoice_HI/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board
